...
namespace Solari.Sol.Abstractions.Extensions
{
    public static class ObjectExtensions
    {
        ...
        {
            return @object == null ? new byte[0] : Encoding.UTF8.GetBytes(SolariJsonSerializer.New.SerializeToJson(@object));
        }
        ...
        {
            return bytes.Length == 0 ? default : SolariJsonSerializer.New.DeserializeFromString<T>(Encoding.UTF8.GetString(bytes));
        }
